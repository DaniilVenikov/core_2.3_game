...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        openZip("/Users/daniil/Games/core_3.2_game/savegames/playersSave.zip",
                "/Users/daniil/Games/core_3.2_game/savegames");
    ...
    public static void openZip(String pathArchive, String pathFile){
        try (ZipInputStream zin = new ZipInputStream(new FileInputStream(pathArchive))){
            ZipEntry zipEntry;
            String name;
